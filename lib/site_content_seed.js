...
export const DEFAULT_HOME_JOURNEY = {
  ...
  subtitle_ar: 'خمس خطوات واضحة — تعرف بالضبط وين حالك بأي لحظة.',
  subtitle_de: 'Fünf klare Schritte — du weißt immer genau, wo du stehst.',
...
const DEFAULT_TEAM_MEMBERS = [
  ...
  { id: uuidv4(), name: 'فاطمة عبد الله', role: 'منسقة الامتحانات', bio: 'حاصلة على شهادة DaF من معهد جوته. مسؤولة عن تنسيق الامتحانات الرسمية وضمان جودة التدريب.', photo: '', order: 2, published: true, linkedIn: '', email: '' },
]
