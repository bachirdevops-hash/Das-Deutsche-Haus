...
export const DEFAULT_HOME_JOURNEY = {
  ...
  title_ar: 'كيف تبدأ رحلتك من هون؟',
...
const DEFAULTS = {
  ...
  about_mission: {
    storyTitle: 'قصتنا',
    story: 'تأسس Das Deutsche Haus عام 2018 على يد فريق من الأكاديميين الألمان والسوريين بهدف بناء جسر تعليمي وثقافي حقيقي بين سوريا وألمانيا. خرّجنا أكثر من 4,200 طالب وطالبة، وأرسلنا 850+ متدرّباً إلى Ausbildung، ونسبة نجاح 94% في امتحانات اللغة الرسمية.',
