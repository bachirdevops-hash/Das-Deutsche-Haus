...
const DEFAULTS = {
  home_hero: {
    ...
    badgePin: 'جديد',
    title_ar: 'بوابتك إلى ألمانيا تبدأ من هنا',
    title_de: 'Dein Tor nach Deutschland beginnt hier',
    desc_ar: 'طريقك إلى ألمانيا يبدأ من هنا — نمشي معك خطوة بخطوة نحو مستقبل ترسمه بيديك.',
    desc_de: 'Dein Weg nach Deutschland beginnt hier — wir begleiten dich Schritt für Schritt in die Zukunft, die du dir wünschst.',
    cta1Label: 'سجّل في كورس',
    cta1Action: 'goto:courses',
    cta2Label: 'تواصل معنا',
    cta2Action: 'goto:contact',
  },
  home_highlights: {
    title: '',
    subtitle: '',
