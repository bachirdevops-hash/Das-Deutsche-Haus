...
export const DEFAULT_PAGE_SETTINGS = {
  ...
  cta2_link: '#booking',
  whatsapp_number: process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || '4915254196668',
...
export const DEFAULT_EMERGENCY_CONTACTS = [
  ...
  // DDH Support
  { id: uuidv4(), category: 'ddh_support', icon: '💬', name: 'Das Deutsche Haus — WhatsApp Support 24/7', phone: process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || '4915254196668', website: '', address: 'Deutsch & Englisch · 7 Tage / 24 Stunden', country: 'Syria', visible: true, sortOrder: 1 },
]
